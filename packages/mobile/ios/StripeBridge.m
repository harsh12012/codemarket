...
// createPaymentIntent
RCT_EXPORT_METHOD(confirmPaymentIntent:(NSString*)clientSecret whitCc:(NSString*)cc withMo:(NSString*)month withYe:(NSString*)year withCvc:(NSString*)cvc callback:(RCTResponseSenderBlock)callback ){
...
// confirmSetupIntend
RCT_EXPORT_METHOD(confirmSetupIntent:(NSString*)clientSecret whitCc:(NSString*)cc withMo:(NSString*)month withYe:(NSString*)year withCvc:(NSString*)cvc callback:(RCTResponseSenderBlock)callback ){
